...
$(document).ready(function () {
    ...
    let closeBtn = document.getElementById('cookies_close');
    let cookiesInfo = document.querySelector('.cookies');
    closeBtn.addEventListener('click', function () {
        cookiesInfo.classList.add('hidden')
    });
